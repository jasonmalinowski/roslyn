...
namespace Microsoft.CodeAnalysis
{
    internal partial class SolutionState
    {
        private abstract partial class CompilationTranslationAction
        {
            ...
            internal class RemoveDocumentAction : SimpleCompilationTranslationAction<DocumentState>
            {
            ...
            internal class AddDocumentsAction : CompilationTranslationAction
            {
            ...
            internal class ProjectParseOptionsAction : SimpleCompilationTranslationAction<ProjectState>
            {
            ...
            internal class ProjectCompilationOptionsAction : SimpleCompilationTranslationAction<CompilationOptions>
            {
            ...
            internal class ProjectAssemblyNameAction : SimpleCompilationTranslationAction<string>
            {
